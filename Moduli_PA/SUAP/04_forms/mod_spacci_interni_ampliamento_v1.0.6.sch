...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <sch:ns uri="../04_forms/spacci_interni_ampliamento_v1.0.6.xsd" prefix="mspaintamp"/>
    ...
    <sch:ns uri="../02_entities/ent_spacci_interni_ampliamento_v1.0.6.xsd" prefix="espaintamp"/>
    <sch:ns uri="../02_entities/ent_files_v1.0.6.xsd" prefix="efile"/>
    <sch:ns uri="../03_sections/sec_spacci_interni_ampliamento_v1.0.6.xsd" prefix="sspaintamp"/>
    ...
    <sch:include href="../02_entities/ent_spacci_interni_ampliamento_v1.0.6.sch#spacci_interni_ampliamento_ab"/>
    <sch:include href="../03_sections/sec_spacci_interni_ampliamento_v1.0.6.sch#sez_spacci_interni_ampliamento"/>
