...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <sch:ns uri="../04_forms/mod_locazione_imprenditoriale_apertura_v1.0.6.xsd" prefix="mlocimpape"/>
    <sch:ns uri="../03_sections/sec_locazioni_imprenditoriale_apertura_v1.0.6.xsd" prefix="slocimpvar"/>
    <sch:ns uri="../03_sections/sec_scheda_anagrafica_v1.0.6" prefix="sschedaanag"/>
    <sch:ns uri="../03_sections/sec_allegati_v1.0.6" prefix="sallegati"/>
