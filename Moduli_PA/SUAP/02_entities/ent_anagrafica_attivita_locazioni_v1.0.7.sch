...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <sch:ns uri="../02_entities/ent_anagrafica_attivita_locazioni_v1.0.7.xsd" prefix="eanagattloc"/>

    <sch:ns uri="../02_entities/ent_anagrafica_attivita_v1.0.7.xsd" prefix="eanagrafica_attivita"/>

    <!--<sch:ns uri="../02_entities/ent_anagrafica_attivita_v1.0.7.xsd" prefix="eanagstruttacc"/> -->
